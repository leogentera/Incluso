...
public class RegistrationIntentService extends IntentService implements RestClientListener {

    public static final String SENT_TOKEN_TO_SERVER = "sentTokenToServer";
    public static final String REGISTRATION_COMPLETE = "registrationComplete";
    public static final String TOKEN = "GCMtoken";

    public static final int SEND_GCM_REGISTRATION=0;
    public static final int SEND_GCM_UNREGISTRATION=1;
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            url= bu_params.getString("url");
            moodleToken= bu_params.getString("moodleToken");
    ...
    private void sendRegistrationToServer(String token) {
        ...
        try {
            ...
            RestClient restClient= new RestClient(this, this, RestClient.POST, "application/json", jsonObject.toString(), SEND_GCM_REGISTRATION );
            restClient.addHeader("Authorization", moodleToken);
