...
angular
    .module('certificationtracker.calendar.global', ['ui.select2', 'ngTagsInput'])
                ...
                columnDefs: [{ field: 'PersonId', displayName: 'Person Id', visible: false },
							...
							},
                            {
                                ...
                                cellTemplate: '<span ng-repeat="item in row.entity.Exams">' +
									'<button type="button" class="square" ng-class="{passed: (item.StatusId == 1), scheduled: (item.StatusId == 2), pending: (item.StatusId == 3)}">E</button></span>',
                                width: 538,
                                headerClass: 'hidden',
                                sortable: false
                            }]
